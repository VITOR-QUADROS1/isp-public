...
echo "[*] Configurando repositórios do Debian 12..."
...
echo "[*] Instalando ferramentas de rede, recursivo e dependências..."
...
echo "[*] Instalando Nginx e Bancos de Dados..."
...
echo "[*] Instalando Winbox via navegador dependências..."
...
echo "[*] Configurando Nginx para porta 8081..."
...
server {
    ...
    location ~ \.php$ {
        include snippets/fastcgi-php.conf; fastcgi_pass unix:/run/php/php8.2-fpm.sock;
...
echo "[*] Configurando DNS Unbound Recursivo..."
